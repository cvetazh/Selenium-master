...
public class GeneralList {
    ...
    @FindBy(xpath = "//div[@class=\"FormAssets_datepicker__3u-Je\"]/div/div")
    private WebElement startDate;

    @FindBy(xpath = "//div[@class=\"FormAssets_datepicker__3u-Je\"][2]/div/div/input")
    ...
    @FindBy(className = "TextArea_textarea__w2Yjz")
